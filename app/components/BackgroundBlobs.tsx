  ...
  return (
    <div className="absolute inset-0 z-0">
      ...
      <div className="absolute inset-0 blur-[150px]">
        ...
        <div
          className={`${styles.animateBlob1} absolute right-114 bottom-0 z-4 h-100 w-82 bg-[#FE7B57]/85`}
        />
        <div
          className={`${styles.animateBlob2} absolute -right-32 -bottom-80 z-3 size-200 rounded-full bg-radial from-[#ff9317] from-40% to-[#ff9317]/20`}
        />
        <div
